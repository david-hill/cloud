...
wget -q "http://rhos-release.virt.bos.redhat.com/poodle-images/rhos-12/?C=M;O=A" -O index.html
version=$(cat index.html  | grep folder | tail -1 | awk -F\" '{ print $8 }')
get_images http://rhos-release.virt.bos.redhat.com/poodle-images/rhos-12/$version
exit $?
