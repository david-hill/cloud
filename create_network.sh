...
neutron subnet-create --name ext-subnet --allocation-pool start=10.1.2.60,end=10.1.2.70 --disable-dhcp $gwarg ext-net 10.1.2.0/24
...
neutron router-interface-add test-router ext-subnet
